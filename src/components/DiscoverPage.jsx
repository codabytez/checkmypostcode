  ...
  return (
    <>
      <div className="px-10 lg:px-[120px] mt-16">
        ...
        <div className="grid grid-rows-5 sm:grid-cols-2 lg:grid-cols-5 gap-5 relative">
          <div className="absolute -top-9 -left-[50px] bg-white rounded-[110%] border-primary h-[90px] w-[calc(100%+100px)] hidden lg:block"></div>
          <div className="absolute -bottom-9 -left-[50px] bg-white rounded-[110%] border-primary h-[90px] w-[calc(100%+100px)] hidden lg:block"></div>
